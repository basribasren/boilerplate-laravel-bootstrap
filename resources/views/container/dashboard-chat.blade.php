...
<div class="full-container">
  <div class="peers fxw-nw pos-r">
    <!-- chat-list.blade.php -->
    @include('component-dashboard.chat.chat-list', 
      array(
    ...
    <div class="peer peer-greed" id='chat-box'>
      <div class="layers h-100">
        ...
        @include('component-dashboard.chat.chat-header', 
          array(
            'id'=>'asdo987wer9876fgdf', 
            'picture'=>'https://randomuser.me/api/portraits/men/1.jpg', 
            'name'=> 'John Doe', 
        ...
        <div class="layer w-100 fxg-1 bgc-grey-200 scrollable pos-r">
          ...
          <div class="p-20 gapY-15">
            ...
            @include('component-dashboard.chat.chat-content')
            <!-- Chat Conversation -->
            <!-- chat-content.blade.php -->
          </div>
        </div>
        ...
        <div class="layer w-100">
          ...
          @include('component-dashboard.chat.chat-input')
        </div>
      </div>
    </div>
  </div>
