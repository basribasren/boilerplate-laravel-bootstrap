...
<div class="row gap-20 masonry pos-r">
  ...
  <div class="masonry-item  w-100">
    <div class="row gap-20">
      <div class='col-md-3'>
        @include('component-dashboard.widgets.stats-summary', 
          array(
            'id'=>'sparklinedash', 
            'title'=>'Total Visits', 
            'color'=> 'green', 
  ...
  <div class="masonry-item col-12">
    <div class="bd bgc-white">
      ...
      @include('component-dashboard.widgets.stats-visits-wrapper')
    </div>
  </div>
      ...
      <div class="layers">
        ...
        <div class="layer bdT p-20 w-100">
          <div class="peers ai-c jc-c gapX-20">
            ...
            @include('component-dashboard.widgets.stats-monthly', 
              array(
                'title'=>'APPL',
                'datapercent'=> 10, 
                'status'=>'up',
  ...
  <div class="masonry-item col-md-6">
    <div class="bd bgc-white p-20">
      <div class="layers">
        ...
        @include('component-dashboard.widgets.stats-todo', 
          array(
            'id'=>'inputCall1',
  ...
  <div class="masonry-item col-md-6">
    <div class="bd bgc-white">
      <div class="layers">
        ...
        @include('component-dashboard.widgets.stats-report', 
          array(
            'name'=>'Item #1 Name',
            'status'=> 'Unavailable', 
            'date'=>'Nov 20',
  ...
  <div class="masonry-item col-md-6">
    <div class="bd bgc-white p-20">
      <div class="layers">
        ...
        @include('component-dashboard.widgets.stats-weather')
      </div>
    </div>
  </div>
      ...
      <div class="layers">
        ...
        <div class="layer w-100">
          ...
          <div class="bgc-grey-200 p-20 gapY-15">
            ...
            @include('component-dashboard.widgets.chat-box',
              array(
            ...
            @include('component-dashboard.widgets.chat-input')
          </div>
        </div>
      </div>
    </div>
