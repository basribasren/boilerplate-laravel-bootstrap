...
<div class="row gap-20 masonry pos-r">
    ...
    <div class="bgc-white p-20 bd">
      ...
      <div class="mT-30">
        <div class="gap-10 peers">
          <!-- button-fill -->
          @include('component.micro.button-fill', 
            array(
              'color'=>'primary', 
              'text'=>'Primary'
            )
        ...
        <div class="w-100 gap-10 peers mY-20">
          <!-- button-outline -->
          @include('component.micro.button-outline', 
            array(
              'color'=>'primary', 
              'text'=>'Primary'
            )
        ...
        <!-- button-group -->
        @include('component.micro.button-group')
      </div>
    </div>
  </div>
  <div class="masonry-item col-md-6">
    <div class="bgc-white p-20 bd">
      ...
      <div class="mT-30">
        <!-- button default -->
        @include('component.micro.dropdown-default', 
          array(
        ...
        <!-- button-split -->
        @include('component.micro.dropdown-split', 
          array(
            'id'=>'dropdownMenuButton', 
            'color'=>'danger',
            'expanded'=> 'false',
  ...
  <div class="masonry-item col-md-6">
    <div class="bgc-white p-20 bd">
      ...
      <div class="mT-30">
        <!-- popover -->
        @include('component.micro.popover')
      </div>
    </div>
  </div>
  <div class="masonry-item col-md-6">
    <div class="bgc-white p-20 bd">
      ...
      <div class="mT-30">
        ...
        <div class="layers">
          <!-- progress -->
          @include('component.micro.progress', 
            array(
  ...
  <div class="masonry-item col-md-6">
    <div class="bgc-white p-20 bd">
      ...
      <div class="mT-30">
       <!-- tooltip -->
        @include('component.micro.tooltip', 
          array(
